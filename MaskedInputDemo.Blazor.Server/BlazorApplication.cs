...
using MaskedInputDemo.Blazor.Server.Services;

namespace MaskedInputDemo.Blazor.Server {
    public partial class MaskedInputDemoBlazorApplication : BlazorApplication {
        public MaskedInputDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void MaskedInputDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
