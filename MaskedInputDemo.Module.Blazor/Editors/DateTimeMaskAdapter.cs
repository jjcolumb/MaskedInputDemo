...
{
    public class DateTimeMaskAdapter : ComponentAdapterBase
    {
        public DateTimeMaskAdapter(TextMaskModel componentModel)
        {
        ...
        {
            return ComponentModelObserver.Create(ComponentModel, DateTimeMaskRenderer.Create(ComponentModel));
        }
