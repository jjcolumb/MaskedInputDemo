...
{
    public class EmailMaskAdapter : ComponentAdapterBase
    {
        public EmailMaskAdapter(TextMaskModel componentModel)
        {
        ...
        {
            return ComponentModelObserver.Create(ComponentModel, EmailMaskRenderer.Create(ComponentModel));
        }
